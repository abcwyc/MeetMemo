...
它适合日常会议、站会、1on1、客户访谈、需求评审、招聘面试等场景。所有会议数据保存在本机，语音识别和大模型服务由用户自行配置。
![](https://file.348580.xyz/2026/05/1d56b39b82e8e5cc26989c7090a976e0.png)
![](https://file.348580.xyz/2026/05/f341d39906e9d46ca7ff23a8e4e8f06d.png)
![](https://file.348580.xyz/2026/05/9c7917e09aa21c6047187165ab4da7f0.png)
...
- 国内服务适配：语音识别默认接入火山引擎豆包流式模型，告别 OpenAI API Key 的充值问题；LLM 端支持配置任意兼容 OpenAI 接口的模型（含 Anthropic），模型自选。
