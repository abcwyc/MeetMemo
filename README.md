<div align="center">
  ...
  <p align="center">
    免费、源码公开、运行在本地的 macOS AI 会议纪要助手（非商业许可）
    <br />
...
![](https://file.348580.xyz/{year}/{month}/{md5}.{extName}/截屏2026-05-31 下午11.33.27.png)
- 自定义会议总结提示词
...
- ❌ 禁止：任何**商业用途**。
- ⚠️ 要求：修改或再分发时，必须保留版权声明（`Required Notice: Copyright (c) 2026 abcwyc`）与本许可证文本。
