  ...
  const features = [
    {
      ...
      description:
        "Records mic + system audio and uses your configured STT provider for real-time transcripts. No meeting bots required.",
    ...
    },
    {
      ...
      description:
        "Generates summaries from transcripts plus your manual notes, powered by your configured LLM.",
      image: "/notes.png",
    },
    {
      ...
      description:
        "Edit the system prompt and bring your own credentials. Everything is stored locally.",
      image: "/settings.png",
    },  
    {
