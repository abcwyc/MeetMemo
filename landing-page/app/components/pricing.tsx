                ...
                <div>
                  ...
                  <div className="space-y-6 text-left">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-white mb-1">Bring Your Own Provider Credentials</h4>
                        <p className="text-gray-300 text-sm">
                          Use the STT and LLM credentials you configure. Pay only for what you use, directly to the providers.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-sm">
                          Costs vary by provider and model choice. Pick affordable transcription and summarization services to keep usage low.
                        </p>
                      </div>
                    </div>
                  </div>
