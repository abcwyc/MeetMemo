      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 mb-4">
              The App relies on third-party services you configure for AI processing. We are not responsible for the availability, accuracy, or performance of those third-party services.
            </p>
          </section>
