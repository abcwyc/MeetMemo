...
///
/// 从用户自托管镜像下载量化模型（全设备统一 4bit+enc 档，不按机器
/// 内存分档）到 `Application Support/MeetMemo/confucius-r2t2/<tier>/`，
/// 供外部 `ws_server.py` 自动发现加载。下载器复刻 `SherpaModelManager`
/// 的断点续传 + SHA256 校验模式（自包含实现，避免改动现有引擎的关键路径）。
@MainActor
final class ConfuciusModelManager: ObservableObject {
    ...
    static let tier4bitEnc = Tier(
        ...
        shortName: "4bit",
        displayName: "4bit+enc",
        gigabytes: "1.5GB",
        files: [
            .init(fileName: "LICENSE-NETEASE", bytes: 11_071, sha256: "4d9321cdad58182faa878b015de7d60069881614ddd7571de70f751a9b8e3811"),
            .init(fileName: "LICENSE-NETEASE-zh", bytes: 7_733, sha256: "18b438311ebb842c15a7c91d9dbb59034efdaf6fff0d105031ef7baf5eeed275"),
            .init(fileName: "NOTICE.md", bytes: 2_019, sha256: "d5a74ca74ab682c5a1d85122aa20328cd59dd5bf02510167717df592967b490c"),
            ...
            .init(fileName: "model.safetensors", bytes: 1_600_478_193, sha256: "e701e6a2b504ee0a26c3dbc2a57f2509d1657893d08a84ad31fd9d5396512649"),
            .init(fileName: "preprocessor_config.json", bytes: 330, sha256: "45e120a4eda2c20c5d7f2ea9354e63536bf35e27aa573fb7cdf78017b378770d"),
            .init(fileName: "quant_config.json", bytes: 70, sha256: "050bdf4f0e0dcf52fad63afe985f7413defce931b049896031c75d195be639dd"),
    ...
    var tierDirectory: URL {
        modelRoot.appendingPathComponent(Self.tier4bitEnc.directoryName, isDirectory: true)
    }

    var activeTier: Tier { Self.tier4bitEnc }
